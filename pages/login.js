    ...
    return (
        <>
            <div className={'container mx-auto'}>
                ...
                <p className={'text-md text-center'}>Login with your spotify account to enjoy this app!</p>
            ...
            <div className={'flex justify-center flex-col mx-5'}>
                ...
                <div className={'my-5 mx-auto'}>
                    <Image alt={'login image'} src={'/peep-standing-25.svg'} width={300} height={500}/>
                </div>
            </div>
